...
var UIGroup = AbstractEntity.extend({
    ...
    construct: function (instance, editor) {
        ...
        this.plug.on('mouseup touchend', function (e) {
            ...
            if (draggedEntity && draggedEntity.type === "wire") {
                draggedEntity.ui.getShape().remove();
        ...
        this.openPropsCmd = new OpenGroupProps(editor, this);
    ...
    onAddSubNode: function (node) {
        ...
        for (var i=0; i < this.wires.length; i++) {
            console.log(this.wires[i].getTargetInstance().name);
