        ...
        bgImg.onload = function() {
            ...
            domEditor.on('mousewheel', function (e) {
                ...
                if(e.originalEvent.wheelDelta/120 > 0) {
                    console.log("ZOOM IN", {x: Math.round((scale.x+ZOOM)*100)/100, y: Math.round((scale.y+ZOOM)*100)/100});
                    this.stage.scale({x: Math.round((scale.x+ZOOM)*100)/100, y: Math.round((scale.y+ZOOM)*100)/100});
                } else {
                    this.stage.scale({x: Math.round((scale.x-ZOOM)*100)/100, y: Math.round((scale.y-ZOOM)*100)/100});
                }
                this.stage.batchDraw();
