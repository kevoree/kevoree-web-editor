...
var UIKevWebEditor = Class({
    ...
    removeUIInstance: function (instancePath, destroy) {
        ...
        if (instanceUI) {
            ...
            delete this.uiInstances[instancePath];
            this.update();
        }
    },
    
    addUIInstance: function (instancePath, ui) {
        this.uiInstances[instancePath] = ui;
    },
    ...
    clean: function () {
        for (var path in this.uiInstances) delete this.uiInstances[path];
