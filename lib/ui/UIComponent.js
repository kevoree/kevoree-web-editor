...
var UIComponent = HostedEntity.extend({
    ...
    construct: function (instance, editor) {
        ...
        function addPortInstances(portTypeList, isProvided) {
            console.log('list', isProvided, portTypeList);
            ...
            while (portTypeList.hasNext()) {
                ...
                console.log('check alreadyCreated '+portTypeRef.name, isAlreadyCreated);
        ...
        console.log("nbProvided", providedCount);
        console.log("nbRequired", requiredCount);
