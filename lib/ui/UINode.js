    ...
    construct: function (instance, editor, hostInstance) {
            ...
            if (draggedElem) {
                if (draggedElem.typeDef && (draggedElem.type === 'component' || draggedElem.type === 'node')) {
                    ...
                    if (draggedElem.instance.path() !== instance.path()) {
                        console.log("Dragged elem is not me, go go add to me");
        ...
        this.shape.on('dragend', function (e) {
            ...
            if (hostInstance) {
                ...
                if (topLevelShape) {
                    console.log("y'a un container en dessous, go fire mouseup");
                    topLevelShape.fire('mouseup');
                } else {
                    console.log('pas de container sur le dragend, on fait rien');
                }
            }
