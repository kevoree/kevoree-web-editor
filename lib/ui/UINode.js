                ...
                if (draggedElem.typeDef && (draggedElem.type === 'component' || draggedElem.type === 'node')) {
                    ...
                    if (draggedElem.instance.path() !== instance.path()) {
                        ...
                        if (draggedElem.type === 'component') {
                            ...
                            addNodeCmd.execute(draggedElem.instance.typeDefinition, draggedElem.instance.name, draggedElem.instance.metaData, instance);
                        }
                    }
                }
            }
        ...
        if (hostInstance) {
            ...
            this.shape.on('dragend', function (e) {
                ...
                if (topLevelShape) {
                    ...
                    // if we endup here this node does not have a host anymore
                    // ask editor UI to add it graphically
                    this.shape.destroy();
                    editor.getUI().addNode(instance);
                    editor.getUI().getUIInstance(instance.path()).getShape().setPosition(editor.getUI().getStage().getPointerPosition());
                }
