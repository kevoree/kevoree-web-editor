 ...
 */
var OpenGroupProps = AbstractCommand.extend({
    toString: 'OpenGroupProps',
    ...
    execute: function (instance) {
        ...
        $('#modal-content').html(templates['group-properties'].render(data, {
