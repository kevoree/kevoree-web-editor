...
var OpenNodeProps = AbstractCommand.extend({
    ...
    execute: function (instance) {
        ...
        groupsSelect.on('change', enableDisablePushPullButtons);
        ...
        pushBtn.on('click', function () {
            ...
            this.pushCmd.execute(uri.host, uri.port, this.editor.getModel(), function (err) {
                ...
                $('#modal-success').html('Model pushed successfully to <strong>ws://'+uri.host+':'+uri.port+'</strong>');
        ...
        pullBtn.on('click', function () {
            ...
            this.pullCmd.execute(uri.host, uri.port, function (err, model) {
                ...
                alert.setHTML('Pull model success', 'ws://'+uri.host+':'+uri.port);
                alert.show(3500);
            }.bind(this));
        }.bind(this));
