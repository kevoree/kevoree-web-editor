...
//    AddNodeLink         = require('../model/AddNodeLink'),
    ...
    SetModel            = require('../model/SetModel'),
...
//        }
        ...
        function retrieveNodeURI() {
            ...
            return {
                host: $('.net-prop-pairs div.ui-selected input.net-prop-value').val(),
                port: dic.findValuesByID('port').value
            }
        }
        
        $('#push-to-node').off('click');
        $('#push-to-node').on('click', function () {
        ...
        $('#pull-from-node').off('click');
        $('#pull-from-node').on('click', function () {
            var uri = retrieveNodeURI();
