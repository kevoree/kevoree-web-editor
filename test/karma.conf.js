...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'bower_components/kevoree-validator/browser/kevoree-validator.js',
      'bower_components/tiny-conf/dist/tiny-conf.js',
      'bower_components/kevoree-commons/browser/kevoree-commons.js',
      'bower_components/kevoree-registry-api/browser/kevoree-registry-api.js',
