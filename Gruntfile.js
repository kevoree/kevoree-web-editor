...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		ngconstant: {
			options: {
				name: 'editorApp',
				deps: false,
				wrap: '// DO NOT EDIT THIS FILE, EDIT THE GRUNT TASK NGCONSTANT SETTINGS INSTEAD WHICH GENERATES THIS FILE\n{%= __ngModule %}'
			},
			dev: {
				options: {
					dest: '<%= yeoman.app %>/scripts/app/app.constants.js'
				},
				constants: {
	...
	grunt.registerTask('test', ['clean:server', 'wiredep', 'ngconstant', 'autoprefixer']);
	...
	grunt.registerTask('default', ['newer:eslint', 'build']);
};
