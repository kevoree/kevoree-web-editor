  ...
  function (KNodeProperties, UINodeProps, AController, PushToCommand, PullFromCommand, Pooffs) {
    ...
    CNodeProperties.prototype.p2cPushModel = function (grpName) {
      if (grpName != undefined) {
        ...
        this._pushCmd.execute(this, editor.getModel(), grp, function (err) {
          if (err) {
            return that._ui.c2pUnableToPush(err.message);
          }
    ...
    CNodeProperties.prototype.p2cPullModel = function (grpName) {
      if (grpName != undefined) {
        ...
        this._pullCmd.execute(this, grp, function (err, pulledModel) {
          if (err) {
            that._ui.c2pUnableToPull(err.message);
            return;
          }

          editor.setModel(pulledModel);
