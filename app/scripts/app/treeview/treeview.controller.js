 ...
 */
angular.module('editorApp').controller('TreeViewCtrl', function($scope, $timeout, $filter, $modal, kEditor, kModelHelper, kFactory, kWs, kFilterParser, saveFile, hotkeys, Notification) {
