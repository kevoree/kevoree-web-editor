...
angular.module('editorApp')
  .factory('instanceGroupPushHolder', function() {
    return {
      host: '127.0.0.1',
      port: '9000',
      path: '/'
  ...
  .controller('InstanceGroupPushCtrl', function($scope, $modalInstance, $timeout, group, kEditor, kWs, instanceGroupPushHolder) {
    $scope.type = 'push to';
    $scope.action = 'push';
    $scope.group = group;
    $scope.selectedHost = instanceGroupPushHolder.host;
    $scope.selectedPort = instanceGroupPushHolder.port;
    ...
    $scope.changeHost = function() {
      instanceGroupPushHolder.host = $scope.selectedHost;
    };
    $scope.changePort = function() {
      instanceGroupPushHolder.port = $scope.selectedPort;
    };
    $scope.changePath = function() {
      instanceGroupPushHolder.path = $scope.selectedPath;
    };
